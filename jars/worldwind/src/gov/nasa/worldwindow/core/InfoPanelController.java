...
/**
 * @author tag
 * @version $Id: InfoPanelController.java 13273 2010-04-10 09:18:33Z tgaskins $
 */
public class InfoPanelController extends AbstractFeature implements SelectListener
{
    ...
    protected AnnotationAttributes getAnnotationPanelAttributes(String annoText)
    {
        ...
        attrs.setAdjustWidthToText(Annotation.SIZE_FIXED);
        ...
        attrs.setBackgroundColor(new Color(0f, 0f, 0f, 0.3f));
    ...
    {
        Dimension lengths = this.computeLenghts(annoText);
     ...
     */
    protected Dimension computeLenghts(String annoText)
    {
        ...
        return new Dimension(lineLength + 5, lines.length + 1); // the 5 and 1 account for slight sizing discrepencies
    }

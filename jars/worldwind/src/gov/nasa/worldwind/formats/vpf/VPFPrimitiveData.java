...
/**
 * @author dcollins
 * @version $Id: VPFPrimitiveData.java 12503 2009-08-21 06:48:37Z dcollins $
 */
public class VPFPrimitiveData
{
    ...
    protected Map<String, CompoundVecBuffer> primitiveCoords;
    protected Map<String, CompoundStringBuffer> primitiveStrings;

    public VPFPrimitiveData()
    {
        this.primitiveInfo = new HashMap<String, PrimitiveInfo[]>();
        this.primitiveCoords = new HashMap<String, CompoundVecBuffer>();
        this.primitiveStrings = new HashMap<String, CompoundStringBuffer>();
    }
    ...
    public CompoundVecBuffer getPrimitiveCoords(String name)
    {
        return this.primitiveCoords.get(name);
    }

    public void setPrimitiveCoords(String name, CompoundVecBuffer coords)
    {
        this.primitiveCoords.put(name, coords);
    }

    public CompoundStringBuffer getPrimitiveStrings(String name)
    {
        return this.primitiveStrings.get(name);
    }

    public void setPrimitiveStrings(String name, CompoundStringBuffer strings)
    {

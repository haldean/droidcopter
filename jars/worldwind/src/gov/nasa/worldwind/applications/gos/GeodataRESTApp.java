...
/**
 * @author dcollins
 * @version $Id: GeodataRESTApp.java 13127 2010-02-16 04:02:26Z dcollins $
 */
public class GeodataRESTApp
{
    static
    {
        Configuration.insertConfigurationDocument("gov/nasa/worldwind/applications/gos/gosapp.config.xml");
        Configuration.insertConfigurationDocument("gov/nasa/worldwind/applications/gos/gosapp.config.rest.xml");

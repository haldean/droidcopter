...
/**
 * @author dcollins
 * @version $Id: CSWRecordList.java 13127 2010-02-16 04:02:26Z dcollins $
 */
public class CSWRecordList extends AVListImpl implements RecordList
{
    ...
    {
        Integer i = WWXML.getInteger(this.doc.getDocumentElement(), "/csw:GetRecordsResponse/csw:SearchResults/@numberOfRecordsMatched", this.xpath);
        return (i != null) ? i : 0;
    }

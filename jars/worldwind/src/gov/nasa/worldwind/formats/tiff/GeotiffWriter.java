 ...
 * @version $Id: GeotiffWriter.java 13245 2010-03-28 10:05:52Z garakl $
 */
...
//            break;
    ...
    private void writeColorImage(BufferedImage image, AVList params) throws IOException {
        ...
        ifds.add(new TiffIFDEntry(Tiff.Tag.SAMPLES_PER_PIXEL, Tiff.Type.SHORT, 1, Tiff.SamplesPerPixel.RGB));
    ...
    private void writeTiffHeader() throws IOException {
        ...
        // Legal values are:
        //      ÒIIÓ (4949.H) a little-endian byte order
        //      ÒMMÓ (4D4D.H) a big-endian byte order (default for Java and for networking
        //

...
/**
 * @author dcollins
 * @version $Id: FGDCServiceStatus.java 13127 2010-02-16 04:02:26Z dcollins $
 */
public class FGDCServiceStatus implements ServiceStatus
{
    ...
    public static ServiceStatus parse(Document doc)
    {
        ...
        xpath.setNamespaceContext(new RESTNamespaceContext());
    ...
    public static OnlineResource createServiceStatusMetadataResource(String uuid)
    {
        ...
        return new BasicOnlineResource(GeodataKey.SERVICE_STATUS_METADATA, "Service Status", uri);
    }
    ...
    public static OnlineResource createServiceStatusResource(String uuid, String serviceType)
    {
        ...
        return new BasicOnlineResource(GeodataKey.SERVICE_STATUS, "Service Status", uri);
    }
    ...
    public OnlineResource getScoreImageResource()
    {
        ...
        URI uri = ResourceUtil.getResourceURI(resourceName);

        return new BasicOnlineResource(GeodataKey.IMAGE, displayText, uri);
    }

...
/**
 * @author brownrigg
 * @version $Id: RPFGenerator.java 6800 2008-09-24 01:14:07Z rick $
 */
class RPFGenerator
{
    ...
    public RPFGenerator(AVList params)
    {
        ...
        this.absentFrames = new AbsentResourceList(-1, -1);
    ...
    private void unmarkFrameFileAbsent(FrameFile frame)
    {
        this.absentFrames.unmarkResourceAbsent(frame.id);
    }
}
...
/**
 * @author tag
 * @version $Id: ImageLibrary.java 13295 2010-04-12 21:07:12Z tgaskins $
 */
public class ImageLibrary
{
    ...
    private static final String[] WARNING_IMAGES = new String[]
        {
            "gov/nasa/worldwindow/images/warning16.png",
            "gov/nasa/worldwindow/images/warning24.png",
            "gov/nasa/worldwindow/images/warning32.png",
            "gov/nasa/worldwindow/images/warning64.png"
        };
    ...
    public static synchronized URL getImageURL(String imageName)
    {
        ...
        if (url == null)
            url = instance.getClass().getResource("/images" + File.separatorChar + imageName);
        if (url == null)
            url = instance.getClass().getResource("gov/nasa/worldwindow/images" + File.separatorChar + imageName);
        if (url == null)
            url = instance.getClass().getResource("/gov/nasa/worldwindow/images" + File.separatorChar + imageName);

...
/**
 * @author dcollins
 * @version $Id: GeodataKey.java 13128 2010-02-16 04:48:05Z dcollins $
 */
public interface GeodataKey
{
    final String ADD_LAYER_ICON = "gov.nasa.worldwind.gos.AddLayerIcon";
    ...
    final String REMOVE_LAYER_ICON = "gov.nasa.worldwind.gos.RemoveLayerIcon";
    final String REST_SERVICE_URI = "gov.nasa.worldwind.gos.RestServiceURI";
    final String RETRIEVED_LAYER_SUFFIX = "gov.nasa.worldwind.gos.RetrievedLayerSuffix";

    final String SEARCH_ICON = "gov.nasa.worldwind.gos.SearchIcon";

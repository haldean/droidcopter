...
/**
 * @author dcollins
 * @version $Id: WWDotNetLayerSetConverter.java 13357 2010-04-30 17:39:47Z dcollins $
 */
public class WWDotNetLayerSetConverter extends AbstractDataStoreProducer
{
    ...
    protected String validateDataSource(Object source, AVList params)
    {
        ...
        try
        {
            ...
            if (event == null || !WWDotNetLayerSetConfiguration.isLayerSetEvent(event))
    ...
    protected Document readLayerSetDocument(Object source)
    {
        ...
        if (!WWDotNetLayerSetConfiguration.isLayerSetDocument(doc.getDocumentElement()))
        {
    ...
    protected Document createDestConfigDoc(Document layerSetDoc, AVList installParams)
    {
        ...
        WWDotNetLayerSetConfiguration.getTiledImageLayerParams(layerSetDoc.getDocumentElement(), params);
        ...
        {
            params.setValue(AVKey.COMPRESS_TEXTURES, Boolean.TRUE);
        }
        // Remove the COMPRESS_TEXTURES parameter for DDS tiles.
        else
        {
            params.removeKey(AVKey.COMPRESS_TEXTURES);
        }

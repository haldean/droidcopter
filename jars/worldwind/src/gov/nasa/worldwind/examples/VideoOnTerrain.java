 ...
 *
 * @author tag
 * @version $Id: VideoOnTerrain.java 13143 2010-02-17 00:52:43Z dcollins $
 */
public class VideoOnTerrain extends ApplicationTemplate
{
    private static final int IMAGE_SIZE = 512;
    private static final double IMAGE_OPACITY = 0.5;
    private static final double IMAGE_SELECTED_OPACITY = 0.8;

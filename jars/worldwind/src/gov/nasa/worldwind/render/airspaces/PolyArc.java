...
/**
 * @author tag
 * @version $Id: PolyArc.java 13347 2010-04-27 23:50:20Z dcollins $
 */
public class PolyArc extends Polygon
{
        ...
        LatLon[] locations)
    {
        ...
        Matrix transform = globe.computeModelCoordinateOriginTransform(center.getLatitude(), center.getLongitude(),
            0.0);

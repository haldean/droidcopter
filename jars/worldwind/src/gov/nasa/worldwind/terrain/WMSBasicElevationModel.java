...
/**
 * @author tag
 * @version $Id: WMSBasicElevationModel.java 13280 2010-04-10 23:12:08Z tgaskins $
 */
public class WMSBasicElevationModel extends BasicElevationModel
{
    ...
    protected static AVList wmsGetParamsFromCapsDoc(Object caps, AVList params)
    {
        if (caps == null)
        {
        ...
        try
        {
            if (caps instanceof Capabilities)
                wmsVersion = ((Capabilities) caps).getVersion();
            else if (caps instanceof WMSCapabilities)
                wmsVersion = ((WMSCapabilities) caps).getVersion();

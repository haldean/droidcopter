...
import org.haldean.chopper.pilot.ChopperMain;
...
public class MainScreen extends ListActivity implements OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.launch_chopper_btn).setOnClickListener(this);
	...
	public void onClick(View v) {
		switch(v.getId()){
			...
			case R.id.launch_chopper_btn:
				startActivity(new Intent(MainScreen.this, ChopperMain.class));
				break;
		}
	}

...
/**
 * @author tag
 * @version $Id: MeasurementDialog.java 13312 2010-04-13 18:28:20Z tgaskins $
 */
public class MeasurementDialog extends AbstractFeatureDialog
{
    ...
    public void initialize(final Controller controller)
    {
        ...
        JButton deleteButton = new JButton(
            new ImageIcon(this.getClass().getResource("/gov/nasa/worldwindow/images/delete-20x20.png")));

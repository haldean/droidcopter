...
/**
 * Handles NavigationImpl routines; calculates next target velocity vector. <P>
 * 
 ...
 */
public class NavigationImpl implements Constants, Receivable, Navigation {
	 ...
	 * @param status The ChopperStatusImpl from which to obtain location information. 
	 */
	public NavigationImpl(ChopperStatus status) {
		if (status == null) {
	...
	/* (non-Javadoc)
	 * @see org.haldean.chopper.pilot.Navigation#evalNextVector(double[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.haldean.chopper.pilot.Navigation#getTarget(double[])
	 */
	...
	/* (non-Javadoc)
	 * @see org.haldean.chopper.pilot.Navigation#getTasks()
	 */
	...
	/* (non-Javadoc)
	 * @see org.haldean.chopper.pilot.Navigation#receiveMessage(java.lang.String, org.haldean.chopper.pilot.Receivable)
	 */
	...
	/* (non-Javadoc)
	 * @see org.haldean.chopper.pilot.Navigation#registerReceiver(org.haldean.chopper.pilot.Receivable)
	 */

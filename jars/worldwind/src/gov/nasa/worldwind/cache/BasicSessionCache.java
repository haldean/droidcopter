 ...
 * Care must be taked by subclasses to ensure that method level synchronization is maintained.
 *
 * @author dcollins
 * @version $Id: BasicSessionCache.java 11456 2009-06-05 06:48:36Z dcollins $
 */
public class BasicSessionCache implements SessionCache
{
     ...
     * this evicts the eldest entiry until the cache size is equal to its capacity.
     *

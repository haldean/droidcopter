 ...
 *
 * @author dcollins
 * @version $Id: VecBuffer.java 12804 2009-11-18 08:41:17Z dcollins $
 */
public class VecBuffer
{
    ...
    /**
     * Constructs a new VecBuffer with the specified vector size, number of vectors, and buffer factory.
     *
     * @param coordsPerVec the number of coordinates per logical vector.
     * @param size         the number of vectors.
     * @param factory      the factory used to a backing BufferWrapper of the appropriate size.
     *
     * @throws IllegalArgumentException if coordsPerElem is 0 or negative, if size is negative, or if the factory is
     *                                  null.
     */
    ...
    {
        protected int position = getSize();
        protected ElementAccessor<T> accessor;

...
public class OGCRequestDescription extends AbstractXMLEventParser
{
    ...
    public OGCOnlineResource getOnlineResouce(String protocol, String requestMethod)
    {
        ...
        {
            if (dct.getProtocol().equalsIgnoreCase(protocol) && dct.getRequestMethod().equalsIgnoreCase(requestMethod))
                return dct.getOnlineResource();
        }

        return null;
    }

    public String getRequestURL(String protocol, String requestMethod)
    {
        OGCOnlineResource ol = this.getOnlineResouce(protocol, requestMethod);

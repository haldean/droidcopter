...
public class Amarino {
	public static final String TAG = "AmarinoStatic";
	public static FileWriter logfile;
	private static AmarinoService amservice;
	
	
	public static void setAmarinoService(AmarinoService serv) {
		amservice = serv;		
	}
	
	public static AmarinoService getAmarinoService() {
		return amservice;
	}
	/**
	...
	public static void sendDataToArduino(Context context, String address, char flag, int data) {
		...
		try {
			if (logfile != null)
				logfile.write(Long.toString(System.currentTimeMillis()) + " " + flag + "" + data + "\n");
		}
		catch (IOException e) {

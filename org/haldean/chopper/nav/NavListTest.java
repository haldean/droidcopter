...
class NavListTest extends TestCase {
	...
	public void testToString() {
		dest = new NavTask[5];
		dest[0] = new NavDest("DEST!300!40.78!-73.97!2!10");
		dest[1] = new NavVel("VEL!1!2!3!4!20");
		dest[2] = new NavDest("DEST!120!38.98!-77.07!1.8!15");
		dest[3] = new NavDest("DEST!1000!32.72!-117.15!2.34!3");
	...
	public void testFromString() {
		...
		NavList myList = NavList.fromString(myString);
